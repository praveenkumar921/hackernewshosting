...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _hacker_news_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./hacker-news.service */
    ...
    function AppComponent_mat_icon_19_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_mat_icon_20_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-icon");
    ...
    function AppComponent_mat_icon_26_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-icon");
    ...
    function AppComponent_mat_icon_27_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-icon");
      ...
      _createClass(AppComponent, [{
        ...
        value: function fetchIds() {
          ...
          if (!this.topStoriesId) {
            this.hackerNewsService.topStories().subscribe(function (data) {
              _this.topStoriesId = data;
              localStorage.setItem('storiesId', JSON.stringify(_this.topStoriesId));

              _this.fetchArticalByIds();
            });
          }
        } // To fetch articales bases on id's fetched from top stores api and store data to local storage.

      }, {
        key: "fetchArticalByIds",
        value: function fetchArticalByIds() {
          var _this2 = this;
          ...
          if (!this.articlesByID || ((_a = this.articlesByID) === null || _a === void 0 ? void 0 : _a.length) === 0) {
            ...
            if (this.topStoriesId) {
              this.topStoriesId.forEach(function (id) {
                _this2.hackerNewsService.getArticlesByID(id).subscribe(function (data) {
                  _this2.articlesByID.push(data);

                  localStorage.setItem('articlesByID', JSON.stringify(_this2.articlesByID));
                  _this2.articlesByID = _toConsumableArray(_this2.articlesByID);
                });
              });
            }
          }
        ...
        value: function sortByScore() {
          if (this.sortScoreAssending) {
            this.articlesByID.sort(function (a, b) {
          ...
          this.articlesByID = _toConsumableArray(this.articlesByID);
        ...
        value: function filterItem(value) {
          ...
          this.articlesByID = Object.assign([], JSON.parse(localStorage.getItem('articlesByID'))).filter(function (item) {
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_hacker_news_service__WEBPACK_IMPORTED_MODULE_1__["HackerNewsService"]));
    };
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function AppComponent_Template_input_input_9_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);

            var _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](10);

            return ctx.filterItem(_r0.value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_span_click_17_listener() {
            return ctx.sortByScore();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
        ...
        return [{
          type: _hacker_news_service__WEBPACK_IMPORTED_MODULE_1__["HackerNewsService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _hacker_news_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./hacker-news.service */
    "./src/app/hacker-news.service.ts");
    /* harmony import */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_5__["MatIconModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_7__["CdkScrollableModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_7__["ScrollingModule"]]]
    });
  ...
  /***/
  function srcAppHackerNewsServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HackerNewsService, [{
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\Angular projects\hackerNewsAPI\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
